...
![Abort controller in the devtool](/posts/aborting-a-fetch-request/abort-controller-devtool-eval.png)
...
![Aborted fetch request in the devtool](/posts/aborting-a-fetch-request/fetch-devtool-cancelled.png)
