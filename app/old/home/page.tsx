...
export const metadata: Metadata = {
  // The retired homepage. Points search engines at the live one.
      ...
      <div className="container-narrow home-v4-container">
          ...
          <div className="hero-v6-grid">
            <div className="hero-v6-main">
              ...
              <div className="hero-actions">
                <Btn variant="primary" withArrow href="/old/about">
                  about
                </Btn>
                <Btn variant="ghost" href="/old/work">
                  selected work →
                </Btn>
              </div>
        ...
        <div className="section">
          ...
          <Reveal>
            ...
            <Link className="see-all" href="/old/work">
        ...
        <div className="section section--loose">
          ...
          <Reveal>
            <Link className="see-all" href="/old/blog">
              all writing →
            </Link>
          </Reveal>
        </div>
